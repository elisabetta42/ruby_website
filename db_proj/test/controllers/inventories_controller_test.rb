...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { owner_user_name: @inventory.owner_user_name, product_id: @inventory.product_id }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { owner_user_name: @inventory.owner_user_name, product_id: @inventory.product_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
