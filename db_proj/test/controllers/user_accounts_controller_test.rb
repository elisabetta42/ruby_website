...
class UserAccountsControllerTest < ActionController::TestCase
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post :create, user_account: { email: @user_account.email, level: @user_account.level, password: @user_account.password, username: @user_account.username }
    end
  ...
  test "should update user_account" do
    patch :update, id: @user_account, user_account: { email: @user_account.email, level: @user_account.level, password: @user_account.password, username: @user_account.username }
    assert_redirected_to user_account_path(assigns(:user_account))
  end
